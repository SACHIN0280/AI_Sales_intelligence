...
function Field({
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      {error && (
        <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} style={{ fontSize: 12, color: "#ef4444", marginTop: 6, fontWeight: 500 }}>
          {error}
        </motion.p>
      )}
    </div>
    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 60 }}>
            <motion.div 
              animate={{ boxShadow: ["0 0 10px #7c5cfc", "0 0 30px #7c5cfc", "0 0 10px #7c5cfc"] }}
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 24, marginBottom: 36, borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
              {(["signin", "signup"] as const).map(t => (
                ...
                >
                  ...
                  {tab === t && (
                    <motion.div layoutId="tabIndicator" style={{ position: "absolute", bottom: -1, left: 0, right: 0, height: 2, background: "#7c5cfc", borderRadius: 2 }} />
                  )}
                </button>
              ))}
            </div>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                key={tab} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = "rgba(255,255,255,0.05)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.15)"; e.currentTarget.style.color = "#fff"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,255,255,0.02)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.08)"; e.currentTarget.style.color = "#d0d0d0"; }}
            >
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media (max-width: 1000px) {
          ...
          body > div > div:nth-of-type(2) { display: none !important; }
          body > div > div:nth-of-type(3) { display: none !important; }
